                ...
                init: function() {
                    ...
                    function fun_buscar()
                    {
                        ...
                        if (cboBusUsuario.getRawValue() != '' && cboBusServicio.getRawValue() != '')
                        {
                            ...
                            {
                                date1 = new Date("01/01/1975").format('d/m/Y H:i:s');
                                // alert('hola');
                            ...
                            {
                                date2 = new Date("01/01/1975").format('d/m/Y H:i:s');
                            }
                            else {
                                date2 = date2.format('d/m/Y H:i:s')
                            }
                            //alert(date1);
                    ...
                    var verUsuario = new Ext.FormPanel({
                        ...
                        buttonAlign: 'center'
                                /*       buttons:[
                                 {text:'Genarar listado PDF',handler: function() {
                                 
                                 window.location =  '/ReportWebUIF/BitacoraListado?usuario='+cboBusUsuario.getRawValue()+'&servicio='+cboBusServicio.getRawValue()+'&ini='+d1+'&fin='+d2;
                                 //BitacoraDato?id=100
                                 }},
                                 {text:'Generar listado XLS',handler: function() {
