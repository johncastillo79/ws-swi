...
public class MenuController {
    ...
    private void menuFromXML(String role) {
        ...
        if (role.equals("admin_uif")) {
            InputStream in = this.getClass().getClassLoader().getResourceAsStream("bo/gob/asfi/uif/swi/web/menu/menuAdmin.xml");
            this.menu = new Menu();
            this.menu = (Menu) xstream.fromXML(in);
        } else if(role.equals("usuario_uif")) {
            InputStream in = this.getClass().getClassLoader().getResourceAsStream("bo/gob/asfi/uif/swi/web/menu/menuUser.xml");
            this.menu = new Menu();
            this.menu = (Menu) xstream.fromXML(in);
        } else if(role.equals("swi")) {
            InputStream in = this.getClass().getClassLoader().getResourceAsStream("bo/gob/asfi/uif/swi/web/menu/menuInit.xml");
            this.menu = new Menu();
            this.menu = (Menu) xstream.fromXML(in);
        }
    }
